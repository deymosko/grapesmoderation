...
When a player receives a new warning, all active warnings have their timer reset.
After a player gets unbanned (ban duration configured via warn-common.toml), all warnings will expire in 7 days.
